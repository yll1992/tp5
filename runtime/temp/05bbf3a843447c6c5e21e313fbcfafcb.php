<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"C:\www\tp5\public/../application/home\view\public\register.html";i:1559554567;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/home/fonts/css/all.css" />
    <link rel="stylesheet" type="text/css" href="/static/home/fonts/css/pages-register.css" />
			...
			<div class="info">
				<form action="" method="post" id="reg_form" class="sui-form form-horizontal">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="phone" name="phone" placeholder="请输入你的手机号" class="input-xfat input-xlarge" value="">
					...
					<div class="control-group">
						...
						$('#dyMobileButton').click(function(){
							var phone=$('#phone').val();
							if(phone){
								$.post("<?php echo url('public/sms'); ?>",{phone:phone},function(returnData){
									if(!returnData.status){
										$('.error:eq(1)').html('短信发送失败');
									}else{
										$('.error:eq(1)').html('短信发送成功');
									}
